...
# Author(s): Unknown - https://www.linuxfromscratch.org/lfs/view/systemd/chapter02/hostreqs.html
# Description:
# - Check that a host system has correct versions of dependency software
